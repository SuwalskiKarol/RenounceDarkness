...
namespace Scripts.FirstLevel {
    ...
    {
        public bool getHit = false, hitting;
        public List<GameObject> weapons = new List<GameObject>();
        public GameObject cross, fireballSpawn, player, fireBall, spawnFire;

        public int HP,damageTaken, rand;
        public float hittingTime = 0f;
        public AudioClip dieSounds, roarClip, fireballSouund;

        public AudioClip[] gethitSounds, idleSounds;
        public KnowledgeSystem EnemyKnowledge { get; set; }
        public Dictionary<StateID, Action> StateIDToActionID { get; set; }
        public int RotateSpeed = 120, fireBallDistance = 20, attackDistance = 3, retreatHealth = 5;
